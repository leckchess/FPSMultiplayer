...
void AFPSMultiplayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AFPSMultiplayerCharacter::OnResetVR);
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AFPSMultiplayerProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void AFPSMultiplayerCharacter::OnResetVR()
{
...
//void AFPSMultiplayerCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
